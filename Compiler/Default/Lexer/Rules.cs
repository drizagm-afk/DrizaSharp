...
{
    public static void OperatorRule(LexContext ctx, ReadOnlySpan<char> content)
    {
        var i = 0;
    ...
    public static void KeywordRule(LexContext ctx, ReadOnlySpan<char> content)
    {
        var i = 0;
        while (i < content.Length)
        {
    ...
    public static void OpenerRule(LexContext ctx, ReadOnlySpan<char> content)
    {
        switch (content[0])
        {
    ...
    public static void CloserRule(LexContext ctx, ReadOnlySpan<char> content)
    {
        switch (content[0])
        {
    ...
    public static void StringKeywordRule(LexContext ctx, ReadOnlySpan<char> content)
    {
